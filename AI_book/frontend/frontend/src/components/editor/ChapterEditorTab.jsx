...
}, selectedChapterIndex = 0, onChapterChange = () => {}, onGenerateChapterContent = () => {}, isGenerating }) => {

    const [isPreviewMode, setIsPreviewMode] = useState(false);
    const [isFullscreen, setIsFullscreen] = useState(false);

    // Simple mark-down parser
                                            ...
                                            <div
                                                ...
                                                dangerouslySetInnerHTML={{
                                                    __html: currentChapter.content
                                                        ...
                                                        : '<p class="mb-4 text-gray-400 italic">No content yet. Start writing to see the preview.</p>',
                                                }}
                                            />
                                        </div>
                                    </div>
